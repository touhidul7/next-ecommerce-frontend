    ...
    <div className="grid lg:grid-cols-3 gap-6">
      ...
      <div className="lg:col-span-2">
        ...
        <div className="grid sm:grid-cols-2 gap-4">
          <Input disabled label="Full Name" value={draft.name} onChange={(v) => setDraft((p) => ({ ...p, name: v }))} />
          <Input disabled label="Phone" value={draft.phone} onChange={(v) => setDraft((p) => ({ ...p, phone: v }))} />
          <Input disabled label="Email" value={draft.email} onChange={(v) => setDraft((p) => ({ ...p, email: v }))} />
        </div>
