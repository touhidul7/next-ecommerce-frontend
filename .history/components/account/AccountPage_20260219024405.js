...
function AddressesSection({ addresses }) {
  return (
    <div className="grid md:grid-cols-2 gap-4">
      {addresses.map((a) => (
        <div key={a.id} className="rounded-2xl border p-5">
          ...
          <div className="mt-4 flex gap-3">
            <button className="rounded-xl border bg-white hover:bg-slate-50 font-bold px-4 py-2 text-sm">
              Set Default
            </button>
      ...
      {/* Add new card */}
      <button className="rounded-2xl border border-dashed p-5 text-left hover:bg-slate-50 transition">
    ...
    <div className="grid lg:grid-cols-2 gap-6">
      ...
      <div className="rounded-2xl border p-5">
        ...
        <div className="mt-4 rounded-xl border bg-white p-4 flex items-center justify-between">
          ...
          <button className="rounded-full border bg-white hover:bg-slate-50 font-bold px-4 py-2 text-sm">
            Setup
          </button>
        </div>
      </div>
