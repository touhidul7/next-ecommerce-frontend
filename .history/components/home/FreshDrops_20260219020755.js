    ...
    return (
        <article className="bg-white rounded-2xl soft-card overflow-hidden">
            ...
            <div className="p-4">
                ...
                <button className="mt-3 w-full rounded-md border-2 border-[#008159] text-[#008159] font-bold py-2.5 text-sm hover:bg-[#008159] hover:text-white"><ShoppingCart className="inline" /> কার্টে যুক্ত করুন 
                </button>
            </div>
        </article>
    );
