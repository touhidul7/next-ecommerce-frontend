      ...
      <Container className="py-8">
        ...
        <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-4">
          ...
          <div className="flex items-center gap-2">
            <a
              href="/"
              className="rounded-full border-gray-300 bg-white px-4 py-2 text-sm font-semibold hover:bg-slate-50"
            >
              ← Continue Shopping
            </a>
            {!isEmpty && (
              <button
                onClick={clearCart}
                className="rounded-full border-gray-300 border-gray-300-red-200 bg-red-50 px-4 py-2 text-sm font-semibold text-red-700 hover:bg-red-100"
              >
                Clear Cart
              </button>
            )}
        ...
        {isEmpty ? (
          ...
          <div className="mt-6 grid lg:grid-cols-3 gap-6">
            ...
            <div className="lg:col-span-2 space-y-4">
              <div className="rounded-2xl bg-white border-gray-300 soft-card overflow-hidden">
                <div className="px-5 py-4 border-gray-300-b flex items-center justify-between">
              ...
              <div className="rounded-2xl border-gray-300 bg-white p-5 soft-card">
                <div className="flex items-start gap-3">
                  <div className="h-10 w-10 rounded-2xl bg-emerald-50 border-gray-300 border-gray-300-emerald-100 flex items-center justify-center">
                    🚚
                  </div>
                  <div>
            ...
            <div className="lg:sticky lg:top-6 h-fit space-y-4">
              ...
              <div className="rounded-2xl border-gray-300 bg-white p-5 soft-card">
                ...
                <div className="mt-3 flex gap-2">
                  <input
                    ...
                    className="flex-1 rounded-xl border-gray-300 px-3 py-2 text-sm outline-none focus:ring-2 focus:ring-emerald-200"
                  />
                  <button
                    onClick={applyCoupon}
              ...
              <div className="rounded-2xl border-gray-300 bg-white p-5 soft-card">
                ...
                <div className="mt-4 space-y-2 text-sm">
                  ...
                  <div className="pt-3 border-gray-300-t flex items-center justify-between">
  ...
  return (
    <div className="p-5 flex flex-col sm:flex-row gap-4">
      ...
      <div className="w-full sm:w-28">
        <div className="aspect-[4/3] rounded-xl bg-slate-100 border-gray-300 flex items-center justify-center text-xs text-slate-400">
          Image
        </div>
      </div>
      ...
      <div className="flex-1">
        ...
        <div className="mt-4 flex flex-col md:flex-row md:items-center md:justify-between gap-3">
          <div className="flex items-center gap-2">
            ...
            {saved > 0 ? (
              <span className="text-xs font-bold rounded-full bg-emerald-50 text-emerald-700 border-gray-300 border-gray-300-emerald-100 px-2 py-1">
                Save ৳ {saved}
              </span>
            ) : null}
          </div>
...
function QtyStepper({ qty, setQty }) {
  return (
    <div className="inline-flex items-center rounded-xl border-gray-300 bg-white overflow-hidden">
      <button
      ...
      <input
        ...
        className="w-12 h-10 text-center text-sm font-bold outline-none border-gray-300-x"
      />
...
function MiniBadge({ icon, text }) {
  return (
    <div className="rounded-xl border-gray-300 bg-slate-50 py-3">
...
function EmptyState() {
  return (
    <div className="mt-10 rounded-2xl border-gray-300 bg-white soft-card p-10 text-center">
      ...
      <div className="mt-6 flex flex-col sm:flex-row gap-3 justify-center">
        ...
        <a
          href="/product"
          className="rounded-xl border-gray-300 bg-white hover:bg-slate-50 font-bold px-6 py-3"
        >
          View Products
        </a>
      </div>
