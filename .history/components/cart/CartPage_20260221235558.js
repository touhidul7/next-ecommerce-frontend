  ...
  const onApplyCoupon = async () => {
    ...
    try {
      ...
      if (response.ok && data.valid) {
        // Apply coupon with the discount amount from API
        applyCoupon({
          code: code,
                ...
                <div className="mt-3">
                  <div className="flex gap-2">
                    ...
                    <button
                      ...
                      className="rounded-xl bg-emerald-600 text-white px-4 py-2 text-sm font-bold hover:bg-emerald-700 disabled:bg-gray-400 disabled:cursor-not-allowed"
                    >
                  ...
                  {appliedCoupon && (
                    <div className="mt-2 text-sm text-emerald-700 font-semibold">
                      ...
                      {appliedCoupon.discount > 0 && ` (Discount: ${formatBDT(appliedCoupon.discount)})`}
                    </div>
                  )}
                </div>
              </div>
