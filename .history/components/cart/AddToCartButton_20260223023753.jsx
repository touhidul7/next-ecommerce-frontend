      ...
      <>
        ...
        {showCartPopup && (
          <>
            ...
            {/* Popup */}
            <div className="fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-white rounded-2xl shadow-2xl z-[10000] w-full max-w-md max-h-[80vh] overflow-y-auto">
              {/* Header */}
                  ...
                  <>
                    <div className="space-y-4 max-h-60 overflow-y-auto pr-2">
                      {items.map((item, index) => (
                        <div key={index} className="flex items-start gap-3 border-b border-gray-100 pb-4">
                          ...
                          {/* Product Details - Clean and simple */}
                              ...
                              <div className="text-right">
                                ...
                                {item.oldPrice && Number(item.oldPrice) > Number(item.price) && (
                                  <span className="text-xs text-gray-400 line-through ml-2">
                                    {formatBDT(Number(item.oldPrice) * Number(item.qty || 1))}
                                  </span>
                                )}
                              </div>
                            </div>
                    ...
                    <div className="mt-6 border-t border-gray-200 pt-4">
                      ...
                      <Link
                        href="/checkout"
                        onClick={() => setShowCartPopup(false)}
                        className="block w-full bg-red-600 text-white text-center px-4 py-3 rounded-xl font-bold hover:bg-red-700 transition-colors"
                      >
                        Proceed to Checkout
                      </Link>
