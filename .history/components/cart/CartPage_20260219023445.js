        ...
        <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-4">
          ...
          <div className="flex items-center gap-2">
            ...
            {!isEmpty && (
              <button
                onClick={clearCart}
                className="rounded-full border border-gray-300-red-200 bg-red-50 px-4 py-2 text-sm font-semibold text-red-700 hover:bg-red-100"
              >
                Clear Cart
              </button>
            )}
  ...
  return (
    <div className="inline-flex items-center rounded-xl border border-gray-300 bg-white overflow-hidden">
      ...
      <input
        ...
        className="w-12 h-10 text-center text-sm font-bold outline-none border border-gray-200"
      />
