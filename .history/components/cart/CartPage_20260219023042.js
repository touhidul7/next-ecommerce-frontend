            ...
            <div className="lg:col-span-2 space-y-4">
              ...
              <div className="rounded-2xl border border-gray-300 bg-white p-5 soft-card">
                <div className="flex items-start gap-3">
                  <div className="h-10 w-10 rounded-2xl bg-emerald-50 border border-gray-300 border border-gray-300-emerald-100 flex items-center justify-center">
                    🚚
                  </div>
                  <div>
      ...
      <div className="flex-1">
        ...
        <div className="mt-4 flex flex-col md:flex-row md:items-center md:justify-between gap-3">
          <div className="flex items-center gap-2">
            ...
            {saved > 0 ? (
              <span className="text-xs font-bold rounded-full bg-emerald-50 text-emerald-700 border border-gray-300 border border-gray-300-emerald-100 px-2 py-1">
                Save ৳ {saved}
              </span>
            ) : null}
          </div>
