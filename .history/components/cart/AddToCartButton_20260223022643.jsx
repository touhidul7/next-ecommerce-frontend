    ...
    <div className="bg-slate-50 min-h-screen">
      <Container className="py-8">
        ...
        <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              className="rounded-full border border-gray-300 bg-white px-4 py-2 text-sm font-semibold hover:bg-slate-50 transition-colors flex items-center gap-2"
            >
              <span>🛒</span>
        ...
        <div className="mt-6 grid lg:grid-cols-3 gap-6">
          ...
          {/* RIGHT - Original Order Summary (Minimal version) */}
          <div className="lg:sticky lg:top-6 h-fit space-y-4">
            <div className="rounded-2xl border border-gray-300 bg-white p-5 shadow-sm">
              <div className="flex items-center justify-between">
                ...
                <button
                  onClick={() => setIsCartDrawerOpen(true)}
                  className="text-xs rounded-full bg-slate-100 px-2 py-1 hover:bg-slate-200 transition-colors flex items-center gap-1"
                >
...
function CartDrawer({ isOpen, onClose, items, subtotal, shipping, discount, total, appliedCoupon, formatBDT }) {
  ...
  return (
    <>
      ...
      {/* Drawer */}
      <div
        className={`fixed top-0 right-0 h-full w-full max-w-md bg-white shadow-2xl transform transition-transform duration-300 ease-in-out z-50 overflow-y-auto ${
          ...
          {items.length === 0 ? (
            ...
            <>
              ...
              <div className="space-y-4 max-h-96 overflow-y-auto pr-2">
                {items.map((item) => (
                  <div
                    key={item.lineId || `${item.id}-${item.qty}`}
              ...
              <div className="mt-6 border-t border-gray-200 pt-4">
                ...
                <div className="space-y-2 text-sm">
                  ...
                  <div className="flex justify-between pt-3 border-t border-gray-200 mt-3">
                    ...
                    <span className="font-extrabold text-xl text-red-800">
                      {formatBDT(total)}
                    </span>
                  </div>
                </div>
              ...
              <div className="mt-6">
                <button
                  onClick={onClose}
                  className="w-full rounded-xl border border-gray-300 bg-white px-4 py-3 font-semibold hover:bg-slate-50 transition-colors"
                >
                  Continue Shopping
                </button>
              </div>
