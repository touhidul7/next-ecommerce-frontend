        ...
        {isEmpty ? (
          ...
          <div className="mt-6 grid lg:grid-cols-3 gap-6">
            ...
            <div className="lg:col-span-2 space-y-4">
              <div className="rounded-2xl bg-white border soft-card overflow-hidden">
  ...
  return (
    <div className="p-5 flex flex-col sm:flex-row gap-4">
      ...
      <div className="w-full sm:w-28">
        <div className="aspect-[4/3] rounded-xl bg-slate-100 border flex items-center justify-center text-xs text-slate-400">
          Image
        </div>
      </div>
      ...
      <div className="flex-1">
        ...
        <div className="mt-4 flex flex-col md:flex-row md:items-center md:justify-between gap-3">
          <div className="flex items-center gap-2">
            ...
            {saved > 0 ? (
              <span className="text-xs font-bold rounded-full bg-emerald-50 text-emerald-700 border border-emerald-100 px-2 py-1">
                Save ৳ {saved}
              </span>
            ) : null}
          </div>
  ...
  return (
    <div className="inline-flex items-center rounded-xl border bg-white overflow-hidden">
      ...
      <input
        ...
        className="w-12 h-10 text-center text-sm font-bold outline-none border-x"
      />
...
function MiniBadge({ icon, text }) {
  return (
    <div className="rounded-xl border bg-slate-50 py-3">
...
function EmptyState() {
  return (
    <div className="mt-10 rounded-2xl border bg-white soft-card p-10 text-center">
      ...
      <div className="mt-6 flex flex-col sm:flex-row gap-3 justify-center">
        ...
        <a
          href="/product"
          className="rounded-xl border bg-white hover:bg-slate-50 font-bold px-6 py-3"
        >
          View Products
        </a>
      </div>
