...
console.log("1. Current cart items from useCart():", JSON.stringify(items, null, 2));
console.log("2. Applied coupon:", appliedCoupon);

// Check each item's structure
items.forEach((item, index) => {
  console.log(`Item ${index}:`, {
    hasProductId: !!item.productId,
    hasProduct_id: !!item.product_id,
    hasVariantId: !!item.variantId,
    hasVariant_id: !!item.variant_id,
    hasSku: !!item.sku,
...
const orderData = {
  ...
  items: items.map((item) => {
    console.log(`Mapping item ${item.name}:`, {
      originalItem: item,
      extractedProductId: item.productId || item.product_id || null,
      extractedVariantId: item.variantId ?? item.variant_id ?? null,
...
console.log("3. Final orderData being sent:", JSON.stringify(orderData, null, 2));
console.log("==================================================");
