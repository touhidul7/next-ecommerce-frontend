    ...
    <div className="bg-slate-50">
      <Container className="py-8">
        ...
        <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-4">
          ...
          <a
            href="/cart"
            className="rounded-full border  border-gray-300 bg-white px-4 py-2 text-sm font-semibold hover:bg-slate-50 w-fit"
          >
            ← Back to Cart
          </a>
        </div>
        ...
        <div className="mt-6 grid lg:grid-cols-3 gap-6">
          ...
          <div className="lg:sticky lg:top-6 h-fit space-y-4">
            <div className="rounded-2xl border  border-gray-300 bg-white p-5 soft-card">
              ...
              <div className="mt-4 rounded-xl bg-slate-50 border  border-gray-300 p-4 text-xs text-slate-600 leading-relaxed">
...
function StepBar({ step }) {
  ...
  return (
    <div className="rounded-2xl border  border-gray-300 bg-white soft-card p-4">
...
function RadioCard({ active, onClick, title, desc, price }) {
  return (
    <button
      onClick={onClick}
      className={[
        "text-left rounded-2xl border  border-gray-300 p-4 transition",
