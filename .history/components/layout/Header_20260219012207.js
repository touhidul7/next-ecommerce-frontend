    ...
    <header className="bg-white border-b">
      <Container className="py-3 flex items-center gap-3">
        ...
        <div className="flex-1 hidden md:flex items-center gap-2">
          <div className="flex-1 relative">
            <input
              className="w-full rounded-full border border-amber-50 bg-white px-4 py-2.5 text-sm outline-none focus:ring-2 focus:ring-emerald-200"
        ...
        <div className="flex items-center gap-3 ml-auto">
          <button className="hidden lg:inline-flex items-center gap-2 rounded-full border px-4 py-2 text-sm">
            🎁 <span>বিশেষ অফার</span>
          </button>

          <button className="relative inline-flex items-center justify-center w-10 h-10 rounded-full border bg-white">
            ❤
      ...
      <div className="md:hidden px-4 pb-3">
        <div className="relative">
          <input
            className="w-full rounded-full border bg-white px-4 py-2.5 text-sm outline-none focus:ring-2 focus:ring-emerald-200"
