        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          {items.map((it, idx) => {
            ...
            return (
              <div
                key={idx}
                className="bg-[#FAFAFA] rounded-sm border border-transparent shadow-[0_0_0_0_rgba(0,0,0,0)]"
              >
                <div className="min-h-[150px] flex items-center gap-6 px-8 py-10 bg-white">
