              ...
              <div>
                <div className="rounded-lg border border-gray-300 bg-white">
                  <div className="relative aspect-[16/9] w-full overflow-hidden rounded-md bg-slate-100">
                    ...
                    {/* Wishlist button */}
                    <button className="absolute right-3 top-3 w-10 h-10 rounded-full bg-white/90 border border-dashed border-sky-400 flex items-center justify-center shadow-sm">
