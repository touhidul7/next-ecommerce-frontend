              ...
              <div>
                ...
                <div className="grid grid-cols-2 gap-3">
                  <AddToCartButton
                    ...
                    getProductImage={getProductImage}
                  />
                  <button className="cursor-pointer mt-4 w-full rounded-md border-2 border-[#008159] text-[#008159] font-bold py-2.5 text-sm hover:bg-[#008159] hover:text-white inline-flex items-center justify-center">
                    অর্ডার করুন
                  </button>
                </div>
